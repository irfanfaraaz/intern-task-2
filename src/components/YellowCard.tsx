...
const YellowCard = () => {
    return (
        <div className="w-full bg-amber-200 mt-24 p-10 flex max-lg:flex-col-reverse mb-24 gap-10">
            <div>
                ...
                <p className="  text-gray-900 text-lg font-normal font-['DM Sans'] leading-7">
                    No matter what your digital needs are, we have the expertise
                    and experience to help you succeed. Explore our services and
                    portfolio to see how we can help you elevate your digital
                    presence. And when you're ready, contact us to schedule a
